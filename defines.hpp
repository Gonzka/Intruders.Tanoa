...
class Checkbox
{
    ...
    tooltipColorBox[] = { 0.7, 0.13, 0.13, 1 }; // Tooltip frame color
...
class RscText {
    ...
    tooltipColorBox[] = {0.7,0.13,0.13,1};
...
class RscTree {
	...
	colorSelect[] = {0.7,0.13,0.13,1}; // Selected item fill color (when multiselectEnabled is 0)
	colorMarked[] = {0.7,0.13,0.13,0.5}; // Marked item fill color (when multiselectEnabled is 1)
	colorMarkedSelected[] = {0.7,0.13,0.13,1}; // Selected item fill color (when multiselectEnabled is 1)
...
class RscButtonMenuPlayBtn : RscShortcutButton {
    idc = -1;
    type = 16;
    style = 0x0800;
    default = 0;
...
class RscStructuredTextBtnTxt2 {
    type = 13;
    style = 0;
    shadow = 0;
    x = 0;
...
class RscButtonMenuPlayBtn2 : RscShortcutButton {
    idc = -1;
    type = 16;
    style = "ST_LEFT";
    default = 0;
...
class RscStructuredTextBtnTxt3 {
    type = 13;
    style = 0;
    shadow = 0;
    x = 0;
...
class RscButtonMenuPlayBtn3 : RscShortcutButton {
    idc = -1;
    type = 16;
    style = "ST_LEFT";
    default = 0;
