/*
	...
	Examples:
	[[["Hello","Is it me you looking for?"],["Bye","Good bye"]],{hint _this;},0.3,0.15] call gonzka_fnc_setWheel; ///Adds "Hello" and "Bye" to the wheel. When selected, hints the name and value.
	...
	},0.3,0.15] call gonzka_fnc_setWheel; ////Simple weapon wheel.			
*/
    ...
    [] spawn {
		...
		if (_isMouse) then {
			_keyUp = _display displayAddEventHandler ["MouseButtonUp", {
			    ...
			    [_displayorcontrol, _button, _shift, _ctrl, _alt] call gonzka_fnc_buttonUp;
			}];
	
			_keyDown = _display displayAddEventHandler ["MouseButtonDown", {
		    	params ["_displayorcontrol", "_button", "_xPos", "_yPos", "_shift", "_ctrl", "_alt"];
				[_displayorcontrol, _button, _shift, _ctrl, _alt] call gonzka_fnc_buttonDown;
			...
			_keyUp = _display displayAddEventHandler ["KeyUp", {
				...
				[_displayorcontrol, _key, _shift, _ctrl, _alt] call gonzka_fnc_buttonUp;
			}];
		
			_keyDown = _display displayAddEventHandler ["KeyDown", {
				params ["_displayorcontrol", "_key", "_shift", "_ctrl", "_alt"];
				[_displayorcontrol, _key, _shift, _ctrl, _alt] call gonzka_fnc_buttonDown;
			}];
