...
["STR_SCORE_Lockpick",1000] call gonzka_fnc_addFunds; 
[_escapeVehicle, "STR_GAME_SuccessLockpick", 10, "textures\gui\hud_escape.paa"] remoteExec ["gonzka_fnc_notification", [0, -2] select isDedicated];
