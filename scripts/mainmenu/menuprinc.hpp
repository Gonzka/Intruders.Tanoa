		...
		class PlayBtnBoxC : RscControlsGroup {
            ...
            class Controls {
                class PlayBtnBoxCTxt: RscStructuredText {
                    idc = 1029;
                    sizeEx = 0.2;
                    text = "<t align='center'><br/><t font='PuristaBold' size='1.3'>INTRUDERS<t font='PuristaSemiBold' size='1'><br/><br/>- DEVELOPER -<t font='PuristaLight' size='0.8'><br/>Gonzka [Scripting]<br/>Affiger_Affe [Mapping]<br/>Alessio [Modding]<br/>MrCat [Modding]<br/><br/><t font='PuristaSemiBold' size='1'>- SERVER TECH -<t font='PuristaLight' size='0.8'><br/>EasyArt<br/><br/><t font='PuristaSemiBold' size='1'>- DESIGNER -<t font='PuristaLight' size='0.8'><br/>ReyzProductions<br/>Affiger_Affe<br/>Kreisverkehr<br/><br/><t font='PuristaSemiBold' size='1'>- VOICEOVER -<t font='PuristaLight' size='0.8'><br/>ArmaOpterix [Martin Opterix]<br/>EasyArt [Hans Rammel]<br/>Gonzka [Helmut, Stanislaw, Sandro]<br/>Sunchay [Bruce Willis]<br/><br/><t font='PuristaSemiBold' size='1'>- THIRD PARTY -<t font='PuristaLight' size='0.8'><br/>game-icons.net [Icons]<br/>zapsplat.com [Sound Effects]<br/>Kevin MacLeod [Music]<br/>Lucas King [Music]<br/>Karl Casey (White Bat Audio) [Music]<br/><br/>CC Attribution<br/><t size='0.5'><a underline='false' href='https://creativecommons.org/licenses/by/4.0/'>https://creativecommons.org/licenses/by/4.0/</a>";
                    x = 0;
                    y = 0;
                    w = 1.46;
                    h = 2.3;
